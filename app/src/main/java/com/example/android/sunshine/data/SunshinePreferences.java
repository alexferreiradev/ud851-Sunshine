...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String userLocation = defaultSharedPreferences.getString(context.getString(R.string.pref_location_key), "");
        /** This will be implemented in a future lesson **/
        return userLocation;
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String userUnits = defaultSharedPreferences.getString(context.getString(R.string.pref_units_key), "");
        String metricUnits = context.getString(R.string.pref_units_metric);

        return userUnits.equals(metricUnits);
    }
